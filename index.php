...
<body>
    ...
    <!-- main -->
    <main>
       <ul class="ls-style questionsContainer">
          <?php 
             foreach($faq as $domErisp) { ?>
               <li class=" questionsList">
                   <h3><?php echo $domErisp['question']; ?></h3>
                   <p class="my-4"><?php echo $domErisp['answer']; ?></p>     
               </li>
          <?php } ?>
      </ul>
    </main>
